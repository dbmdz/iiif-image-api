...
public class IIIFImageApiControllerTest {
  ...
  public void getZendInfo() throws Exception {
    mockMvc.perform(get("/iiif/image/http-bsb/info.json"))
            ...
            .andExpect(jsonPath("$.@id").value("http://localhost/iiif/image/http-bsb"))
  ...
  public void getFedoraInfo() throws Exception {
    mockMvc.perform(get("/iiif/image/file-zoom/info.json"))
            .andExpect(status().isOk())
            .andExpect(content().contentType("application/json"))
  ...
  public void testScaleWithMissingWidth() throws Exception {
    byte[] imgData = mockMvc.perform(get("/iiif/image/file-zoom/full/200,/0/native.jpg"))
            .andExpect(status().isOk())
  ...
  public void testScaleWithRelativeValues() throws Exception {
    byte[] imgData = mockMvc.perform(get("/iiif/image/file-zoom/full/pct:50/0/native.jpg"))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
    Image image = loadImage(imgData, true);
  ...
  public void testScaleWithBestWidth() throws Exception {
    byte[] imgData = mockMvc.perform(get("/iiif/image/file-zoom/full/!500,500/0/native.jpg"))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
    Image image = loadImage(imgData, true);
  ...
  public void testScaleWithZeroSize() throws Exception {
    mockMvc.perform(get("/iiif/image/file-zoom/full/!500,0/0/native.jpg"))
  ...
  public void testCropWithAbsoluteValues() throws Exception {
    byte[] imgData = mockMvc.perform(get("/iiif/image/file-zoom/20,20,50,50/full/0/native.jpg"))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
    Image image = loadImage(imgData, true);
  ...
  public void testCropWithRelativeValues() throws Exception {
    byte[] imgData = mockMvc.perform(get("/iiif/image/file-zoom/pct:10,10,10,10/full/0/native.jpg"))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
    Image image = loadImage(imgData, true);
  ...
  public void testCropWithRelativeValuesPartiallyExceeding() throws Exception {
    byte[] imgData = mockMvc.
            perform(get("/iiif/image/file-zoom/pct:20,20,100,10/full/0/native.jpg"))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
    Image image = loadImage(imgData, true);
    Assert.assertEquals(256, image.getHeight());
  ...
  public void testCropWithAbsoluteValuesTotallyExceeding() throws Exception {
    mockMvc.perform(get("/iiif/image/file-zoom/5000,5000,100,100/full/0/native.jpg"))
            .andExpect(status().is((400)));
  }

  @Test
  public void testWeirdCropBug() throws Exception {
    byte[] imgData = mockMvc.perform(get("/iiif/image/http-google/0,0,1500,2048/750,/0/native.jpg"))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
    Image image = loadImage(imgData, true);
  ...
  public void testRotation() throws Exception {
    byte[] imgData = mockMvc.
            perform(get("/iiif/image/http-google/0,0,1500,2048/750,/90/native.jpg"))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
    Image image = loadImage(imgData, true);
  ...
  public void testMirror() throws Exception {
    byte[] imgDataRegular = mockMvc.
            perform(get("/iiif/image/http-google/0,0,1500,2048/750,/0/native.jpg"))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
  ...
  public void testGrayscaling() throws Exception {
    byte[] imgData = mockMvc.perform(get("/iiif/image/http-google/0,0,1500,2048/750,/90/gray.jpg").
            header("Referer", "http://localhost/foobar"))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
  ...
  public void testBinarization() throws Exception {
    byte[] imgData = mockMvc.
            perform(get("/iiif/image/http-google/0,0,1500,2048/750,/90/bitonal.png").
                    header("Referer", "http://localhost/foobar"))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
    BufferedImage image = ((JAIImage) loadImage(imgData, false)).getImage();
  ...
  public void testConvertPng() throws Exception {
    byte[] imgData = mockMvc.perform(get("/iiif/image/http-google/full/full/0/default.png").
            header("Referer", "http://localhost/foobar"))
            .andExpect(status().isOk())
  ...
  public void testCorsHeader() throws Exception {
    ...
    mockMvc.perform(get("/iiif/image/http-google/info.json")
  ...
  public void testUrlEncodedIdentifiers() throws Exception {
    mockMvc.perform(get("/iiif/image/" + URLEncoder.
            encode("spec:/ial?file#with[special]ch@arac%ters", "utf8") + "/info.json")
            .header("Referer", "http://localhost/foobar"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.@id").
                    value("http://localhost/iiif/image/spec%253A%252Fial%253Ffile%2523with%255Bspecial%255Dch%2540arac%2525ters"));
  }

  @Test
  public void testContentDispositionHeader() throws Exception {
    mockMvc.perform(get("/iiif/image/http-google/full/full/0/default.png").
            header("Referer", "http://localhost/foobar"))
            .andExpect(status().isOk())
            .andExpect(content().contentType("image/png"))
            .andExpect(header().
                    string("Content-Disposition", "attachment; filename=http-google_full_full_0_default.png"));
  }
}
